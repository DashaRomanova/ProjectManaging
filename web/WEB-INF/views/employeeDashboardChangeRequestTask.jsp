  ...
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="/employee/showAllRequestsByEmployeeIdPage?employeeId=${employee.userId}">Requests</a></li>
      </ul>
    </div>
    ...
    <c:choose>
      ...
      <c:otherwise>
        <h1 class="row">You do not have requests for changing estimate of tasks!</h1>
      </c:otherwise>
    </c:choose>
    </div>
  </div>
