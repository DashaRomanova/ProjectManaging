  ...
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      <ul class="nav nav-sidebar">
        ...
        <li><a href="/showAllAssignedTasksByEmployeeIdPage?employeeId=${employee.userId}">Assigned Task</a></li>
        ...
        <li class="active"><a href="/showAllRequestsByEmployeeIdPage?employeeId=${employee.userId}">Requests</a></li>
      </ul>
    </div>
