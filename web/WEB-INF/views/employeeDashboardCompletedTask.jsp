  ...
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      <ul class="nav nav-sidebar">
        <li class="active"><a href="/employee/showAllCompletedTasksByEmployeeIdPage?employeeId=${employee.userId}">Completed Task</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-2 main">
      <c:choose>
        ...
        <c:otherwise>
          <h1 class="row">You do not have completed tasks!</h1>
        </c:otherwise>
      </c:choose>
    </div>
  </div>
