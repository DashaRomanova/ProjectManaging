      ...
      <ul class="nav nav-sidebar">
        <li>Reports
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="/projectManager/chooseEmployeeForTaskReportPage?managerId=${manager.userId}">Employee statistic of time deviation from predicted by tasks</a></li>
          </ul>
        </li>
      </ul>
    </div>
    <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-2 main">
      <c:choose>
        <c:when test= "${fn:length(listTasks) > 0}">
          <h1 class="page-header">Employee ${employee.surname} ${employee.name} statistic of time deviation from predicted by tasks</h1>
        ...
        <c:otherwise>
          <h1 class="row">Employee ${employee.surname} ${employee.name} has not got any time deviation from predicted by tasks!</h1>
        </c:otherwise>
      </c:choose>
    </div>
  </div>
