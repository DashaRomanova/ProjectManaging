  ...
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        <li>Reports
          <ul class="nav nav-sidebar">
            <li class="active"><a href="/projectManager/chooseProjectForOvertimeReportPage?managerId=${manager.userId}">Overtime</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-2 col-md-10 col-md-offset-2 main">
      <c:choose>
        <c:when test= "${fn:length(employees) > 0}">
          ...
          <h2 class="row">Sprint: ${sprintName}</h2>
          <h4 class="row">Employees who has overtime</h4>
        ...
        <c:otherwise>
          <h2 class="row">There is not any employee who has overworked!</h2>
        </c:otherwise>
      </c:choose>
    </div>
  </div>
