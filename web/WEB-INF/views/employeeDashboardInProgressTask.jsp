  ...
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="/showAllInProgressTasksByEmployeeIdPage?managerId=${employee.userId}">Task in progress</a></li>
        ...
        <li><a href="/showAllRefusedTasksByEmployeeIdPage?managerId=${employee.userId}">Refused request task</a></li>
          ...
          <c:if test= "${fn:length(listTasks) > 0}">
            <c:forEach items="${listTasks}" var="task" varStatus="loopStatus">
              <tr>
                ...
                <td><a class="btn btn-default" href="/completeTask?taskId=${task.taskId}" role="button">Complete</a></td>
              </tr>
            </c:forEach>
          </c:if>
          </tbody>
