  ...
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="/employee/showAllInProgressTasksByEmployeeIdPage?employeeId=${employee.userId}">Task in progress</a></li>
    ...
    <c:choose>
            ...
            <tbody>
              <c:forEach items="${listTasks}" var="task" varStatus="loopStatus">
                <tr>
                  ...
                  <form class="form-horizontal" action="/employee/completeTask" method="POST">
                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                    <input type="hidden" id="taskId" name="taskId" value="${task.taskId}"/>
                    <td>
                      <input type="number" min="1" class="form-control" id="actualEstimate" name="actualEstimate" required placeholder="Enter actual estimate in hours">
      ...
      <c:otherwise>
        <h1 class="row">You do not have tasks in progress!</h1>
      </c:otherwise>
    </c:choose>
    </div>
  </div>
