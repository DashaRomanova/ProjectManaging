  ...
  <div class="row">
    <div class="col-sm-3 col-md-2 sidebar">
      <ul class="nav nav-sidebar">
        ...
        <li class="active"><a href="/employee/showAllAssignedTasksByEmployeeIdPage?employeeId=${employee.userId}">Assigned Task</a></li>
    ...
    <c:choose>
            ...
            <tbody>
              <c:forEach items="${listTasks}" var="task" varStatus="loopStatus">
                <tr>
                  ...
                  <td><a class="btn btn-default" href="/employee/requestEstimateTaskPage?taskId=${task.taskId}" role="button">Request</a></td>
                </tr>
              </c:forEach>
            </tbody>
          </table>
      ...
      <c:otherwise>
        <h1 class="row">You do not have assigned tasks!</h1>
      </c:otherwise>
    </c:choose>
    </div>
  </div>
